...
public class BankGHB0001Activity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
                ...
                setContentView(R.layout.bank_all_ghb);
                ...
                listAdapter = new CustomAdapter(BankGHB0001Activity.this, deptList);
    ...
    if (isExpand) {
            ...
            collapseAll();
             ...
             private void loadData() {
                 ...
                 addProduct("ผู้ใช้งาน", "ชื่อ - สกุล :");
                 addProduct("ผู้ใช้งาน", "เลขที่สมาชิก/ผู้ประเมินหลัก :");
                 addProduct("ผู้ใช้งาน", "หนังสือเลขที่ :");
                 addProduct("ผู้ใช้งาน", "ลงวันที่ :");
                 ...
                 addProduct("สังกัดหน่วยงาน", "ฝ่าย");
                 addProduct("สังกัดหน่วยงาน", "สาขา");
                 addProduct("สังกัดหน่วยงาน", "ศุนย์");
